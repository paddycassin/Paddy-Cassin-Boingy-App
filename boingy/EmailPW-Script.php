...
if (isset($_SESSION['EmailPW'])) {
  $colname_EmailPassword = $_SESSION['EmailPW'];
}
...
mail ( $email, $subject, $message, "From:". $from);
	...
	if ($totalRows_EmailPassword >0){
		...
		echo "Fail - Please try again to rest password";
	}
?>
